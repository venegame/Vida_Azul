...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container">
            ...
            if ($stmt->execute()) {
                echo "<div class='alert alert-success' role='alert'>Rol eliminado exitosamente.</div>";
            } else {
                echo "<div class='alert alert-danger' role='alert'>Error al eliminar el rol: " . $conexion->error . "</div>";
            }
            ...
            <div class="row">
                <div class="col text-center">
                    <a href="../rol/listado.php" class="btn btn-secondary">Regresar</a>
                </div>
            </div>
        </div>
    </main>
