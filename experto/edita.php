        ...
        <div class="container">
            ...
            <form action="#" class="row g-3" method="POST">
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" name="id_experto" value="<?php echo $id; ?>"
                        readonly></input>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="nombre_experto" value="<?php echo $nombre_experto; ?>"
                        required>
                </div>
                <div class="col-md-6">
                    <label for="quienes_somos" class="form-label">¿Quiénes Somos?</label>
                    <textarea class="form-control" name="quienes_somos" rows="5"
                        required><?php echo htmlspecialchars($quienes_somos); ?></textarea>
                </div>
                <div class="col-md-6">
                    <label for="historia_expertos" class="form-label">Historia</label>
                    <textarea class="form-control" name="historia_expertos" rows="5"
                        required><?php echo htmlspecialchars($historia_expertos); ?></textarea>
                </div>
                <div class="col-md-3">
