        ...
        <div class="container">
            ...
            <form action="#" class="row g-3" method="POST">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="id_recurso" name="id_recurso" value="<?php echo $id; ?>" readonly></input>
                </div>
                <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descripcion" name="descripcion" rows="7"><?php echo htmlspecialchars($descripcion); ?></textarea>
                </div>
                <div class="col-12">
